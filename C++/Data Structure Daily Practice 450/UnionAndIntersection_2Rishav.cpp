...
Pair Union_intersection_in_array(int arr1[],int arr2[],int l1,int l2)
{
...
union_no=l1+l2-size;
Pair p1;
p1.intersection=size;
p1.union_1=l1+l2-size;
return p1;
}
...
int main(){
    ...
    cout<<endl;
    Pair p2=Union_intersection_in_array(arr_1,arr_2,n1,n2);
    cout<<"Intersection Count: "<<p2.intersection<<"\n";
    cout<<"Union Count: "<<p2.union_1<<"\n";
